...
public class SocketEvents {
    ...
    public static final String EMITTER_USER_NAME_LIST = "user_name_list";
    public static final String CATCHER_MESSAGE_TO_USER = "message_to_user";
    public static final String EMITTER_MESSAGE_TO_USER = "message_to_user";
